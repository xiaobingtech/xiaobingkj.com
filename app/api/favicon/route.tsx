...
const faviconMapper: { [key: string]: string } = {
  '((?:zolplay.cn)|(?:zolplay.com)|(?:cn.zolplay.com))':
    'https://xiaobingkj.com/favicons/zolplay.png',
  '(?:github.com)': 'https://xiaobingkj.com/favicons/github.png',
  '((?:t.co)|(?:twitter.com)|(?:x.com))':
    'https://xiaobingkj.com/favicons/twitter.png',
  'coolshell.cn': 'https://xiaobingkj.com/favicons/coolshell.png',
  'vercel.com': 'https://xiaobingkj.com/favicons/vercel.png',
  'nextjs.org': 'https://xiaobingkj.com/favicons/nextjs.png',
}
...
export async function GET(req: NextRequest) {
  ...
  let iconUrl = 'https://xiaobingkj.com/favicon_blank.png'
